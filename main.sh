...
# -------------------------
select_os() {
    echo -e "${yellow}Select your OS:${reset}"
    echo "1) Debian"
    echo "2) Ubuntu"
    while true; do
        read -p "$(echo -e ${magenta}Choose 1 or 2: ${reset})" os_choice
        case $os_choice in
            1) OS="debian"; PM="apt-get"; break ;;
            2) OS="ubuntu"; PM="apt-get"; break ;;
            *) echo -e "${red}Invalid choice${reset}";;
        esac
    done
    echo -e "${green}Selected OS: $OS${reset}"
}
...
install_dependencies() {
    ...
    print_status "INFO" "Installing essential tools..."
